...
class KeyboardDeviceWidget(QGraphicsItem):
    ...
    def __init__(self, keys, name, parent=None):
        ...
        for key in keys:
            key = KeyWidget(key, 'A', parent=self)
...
class Window(QWidget):
    ...
    def __init__(self):
        ...
        test_items = [
            ("60%", "test-60-percent.json"),
            ("dox-left",  "test-dox-left.json"),
            ("dox-right", "test-dox-right.json"),
            ("mine-v5", "test-mine-v5.json"),
        ]
